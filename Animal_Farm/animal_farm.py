...
if __name__ == '__main__':
    ...
    available_food = ['сено', 'трава', "зерно", "пшено", "каша", "мясо", "кость", "тортик", "кролик", "курица", "ягненок", "фасоль", "яблоко", "молоко", "кебаб", "клубника"]
    heath_list = [True, False]
    what_we_got = list()
    what_we_lost = list()
    for animal in animals:
        ...
        for health in choices(heath_list, k=1):
            animal.health = health
        animal.visit_a_doctor()
        print('=' * 20)
